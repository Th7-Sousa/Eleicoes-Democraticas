window.onload = function () {
  ...
  var AreaQuestao = document.getElementsByClassName('questoes')[0],
      ...
      BancoQuestoes = {
        ' A urna eletrônica, como se concebe hoje, foi desenvolvida em...' : ['1995', '1993', '1988', 0],
        
        'Quais são os beneficios da urna eletrônica?' : ['Rapidez e Menor segurança', 'Rapidez e Maior segurança' , 'Nenhum beneficio', 1],
        
        'Qual tecnologia foi recentemente implementada para verificar ou identificar uma pessoa por meio de um Scanner? ' : ['Sistema de Biometria','Reconhecimento Facial', 'Reconhecimento por voz', 0],

        'Em qual intervalo de idade o voto NÃO é obrigatorio?' : ['maiores de 16 anos e menores de 18 anos', 'maiores de 16 anos e menores de 21 anos;', 'menores de 70 anos', 0]
      };
